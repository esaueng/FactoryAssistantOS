...
| `rootfs-overlay/usr/share/factory-assistant/` | Industrial default templates: Core `configuration.yaml`, `factory-assistant` UI theme (`themes/`), "Plant overview" dashboard (`dashboards/`) — see `docs/INDUSTRIAL_DEFAULTS.md` and `docs/UI_DESIGN.md` |
